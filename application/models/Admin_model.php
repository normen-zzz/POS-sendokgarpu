...
class Admin_model extends CI_Model
{
    ...
    public function getBarang()
    {
        ...
        $this->db->join('user u', 'j.user_id = u.id_user');
        $this->db->order_by('stok', 'ASC');
        return $this->db->get('barang b')->result_array();
    }

    public function getBarangAdjust()
    {
        $this->db->join('jenis j', 'b.jenis_id = j.id_jenis');
        $this->db->join('user u', 'j.user_id = u.id_user');
        $this->db->where('adjustment !=', null);
        return $this->db->get('barang b')->result_array();
    }
    ...
    public function min($table, $field, $min)
    {
        ...
        $this->db->join('jenis', 'jenis.id_jenis =' . $table . '.jenis_id');
        $this->db->order_by($table . '.stok', 'ASC');
