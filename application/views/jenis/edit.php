    ...
    <div class="col-md-8">
        <div class="card shadow-sm border-bottom-primary">
            ...
            <div class="card-body">
                ...
                <?= form_open('', [], ['id_jenis' => $jenis['id_jenis'], 'user_id' => $this->session->userdata('login_session')['user']]); ?>
                <div class="row form-group">
                    <div class="col-md-4">
                        <input hidden value="<?= set_value('updated_at', date('Y-m-d h:i:s')); ?>" name="updated_at" id="updated_at" type="text">
                        <?= form_error('updated_at', '<small class="text-danger">', '</small>'); ?>
                    </div>
                </div>
                <div class="row form-group">
