							...
							<div class="card-body">
								<div class="form-floating mb-3">
									<form action="<?= base_url('Auth') ?>" method="POST">
										<input type="number" class="form-control" id="floatingInput" name="pin" placeholder="PIN" />
										<button type="submit" style="background-color: #6c221f;color: white;"  class="btn mt-2" >Login</button>
									</form>
